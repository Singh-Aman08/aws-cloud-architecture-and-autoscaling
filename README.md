...
- Develop a highly available architecture for **ArtAI**, supporting secure AI model deployment, efficient image processing, and reliable data management.
...
The **WordFreq** application was deployed using AWS services and enhanced with an automated scaling mechanism. Cloud monitoring and Auto Scaling were configured to dynamically manage compute resources according to workload changes.
...
The project resulted in two AWS-based application architectures designed to address different cloud computing requirements: AI-powered image processing and distributed data processing.
...
- Designed an architecture supporting global access and efficient request delivery.
- Deployed the AI inference model within controlled AWS network infrastructure.
...
- Integrated access control and monitoring mechanisms to protect application resources.
...
- Improved processing performance through parallel execution and infrastructure optimisation.
...
Load testing demonstrated that increasing compute resources and optimising scaling parameters improved the processing performance of the WordFreq application.
...
The best observed configuration processed the test workload in:

**3 minutes 45 seconds**

The results demonstrate how compute capacity, scaling configuration, and parallel processing can affect the performance of distributed cloud workloads.
...
The **WordFreq** architecture demonstrated the use of cloud-native services to build an event-driven distributed processing system with workload-based auto-scaling. The performance evaluation highlighted how appropriate scaling strategies and infrastructure choices can improve processing efficiency and responsiveness.

Overall, this project provided practical experience in **cloud architecture design, AWS infrastructure management, distributed systems, auto-scaling, load testing, and performance optimisation**.
